...
var _baseUrl, _clientId, _clientSecret, _customFetch, _getConfiguration, _baseUrl2, _clientId2, _customFetch2, _grantRequest, _Class0_brand, _baseUrl3, _domain, _clientId3, _customFetch3, _clientAuthOptions, _Class10_brand, _entries, _ttlMs, _maxEntries, _configuration, _serverMetadata, _clientAuthPromise, _options, _customFetch4, _jwks, _discoveryCache, _inFlightDiscovery, _jwksCache, _Class12_brand;
...
_customFetch3 = new WeakMap, _clientAuthOptions = new WeakMap, _Class10_brand = new WeakSet, 
class PasswordlessClient {
    ...
    async sendEmail(options) {
        await _assertClassBrand(_Class10_brand, this, _start).call(this, transformSendEmailRequest(options), "Failed to send passwordless email", options.language);
    }
    async sendSms(options) {
        ...
        await _assertClassBrand(_Class10_brand, this, _start).call(this, transformSendSmsRequest(options), "Failed to send passwordless SMS", options.language);
    }
});
...
function getTelemetryConfig(config) {
    ...
    return {
        ...
        version: (_config$version = config === null || config === void 0 ? void 0 : config.version) !== null && _config$version !== void 0 ? _config$version : "1.10.0"
    };
}
...
function appendExtraParams(params, extra) {
    if (!extra) return;
    for (const _ref4 of Object.entries(extra)) {
        var _ref5 = _slicedToArray(_ref4, 2);
        const parameterKey = _ref5[0];
        const parameterValue = _ref5[1];
...
_options = new WeakMap, _customFetch4 = new WeakMap, _jwks = new WeakMap, _discoveryCache = new WeakMap, 
_inFlightDiscovery = new WeakMap, _jwksCache = new WeakMap, _Class12_brand = new WeakSet, 
class AuthClient {
    constructor(_options2) {
        var _options2$customFetch;
        _classPrivateMethodInitSpec(this, _Class12_brand);
        ...
        _classPrivateFieldSet2(_customFetch4, this, createTelemetryFetch((_options2$customFetch = _options2.customFetch) !== null && _options2$customFetch !== void 0 ? _options2$customFetch : function() {
            return fetch(...arguments);
        ...
        this.mfa = new MfaClient({
            ...
            customFetch: _classPrivateFieldGet2(_customFetch4, this),
            getConfiguration: async () => (await _assertClassBrand(_Class12_brand, this, _discover).call(this)).configuration
        });
        this.passkey = new PasskeyClient({
            ...
            grantRequest: async (grantType, params) => {
                const _await$_assertClassBr = await _assertClassBrand(_Class12_brand, this, _discover).call(this), serverMetadata = _await$_assertClassBr.serverMetadata;
                const configuration = await _assertClassBrand(_Class12_brand, this, _createConfiguration).call(this, serverMetadata);
                configuration[customFetch$1] = createPasskeyFetch(_classPrivateFieldGet2(_customFetch4, this), grantType);
    ...
    async getServerMetadata() {
        const _await$_assertClassBr2 = await _assertClassBrand(_Class12_brand, this, _discover).call(this), serverMetadata = _await$_assertClassBr2.serverMetadata;
        return serverMetadata;
    }
    async buildAuthorizationUrl(options) {
        const _await$_assertClassBr3 = await _assertClassBrand(_Class12_brand, this, _discover).call(this), serverMetadata = _await$_assertClassBr3.serverMetadata;
        ...
        try {
            return await _assertClassBrand(_Class12_brand, this, _buildAuthorizationUrl).call(this, options);
        } catch (e) {
    ...
    async buildLinkUserUrl(options) {
        try {
            const result = await _assertClassBrand(_Class12_brand, this, _buildAuthorizationUrl).call(this, {
    ...
    async backchannelAuthentication(options) {
        const _await$_assertClassBr4 = await _assertClassBrand(_Class12_brand, this, _discover).call(this), configuration = _await$_assertClassBr4.configuration, serverMetadata = _await$_assertClassBr4.serverMetadata;
    ...
    async initiateBackchannelAuthentication(options) {
        const _await$_assertClassBr5 = await _assertClassBrand(_Class12_brand, this, _discover).call(this), configuration = _await$_assertClassBr5.configuration, serverMetadata = _await$_assertClassBr5.serverMetadata;
        const additionalParams = stripUndefinedProperties(_objectSpread2(_objectSpread2({}, _classPrivateFieldGet2(_options, this).authorizationParams), options === null || options === void 0 ? void 0 : options.authorizationParams));
        const params = new URLSearchParams(_objectSpread2(_objectSpread2({
            scope: DEFAULT_SCOPES
        }, additionalParams), {}, {
    ...
    async backchannelAuthenticationGrant(_ref8) {
        let authReqId = _ref8.authReqId;
        const _await$_assertClassBr6 = await _assertClassBrand(_Class12_brand, this, _discover).call(this), configuration = _await$_assertClassBr6.configuration;
        const params = new URLSearchParams({
    ...
    async exchangeToken(options) {
        return "connection" in options ? _assertClassBrand(_Class12_brand, this, _exchangeTokenVaultToken).call(this, options) : _assertClassBrand(_Class12_brand, this, _exchangeProfileToken).call(this, options);
    }
    async getTokenByCode(url, options) {
        const _await$_assertClassBr7 = await _assertClassBrand(_Class12_brand, this, _discover).call(this), configuration = _await$_assertClassBr7.configuration;
        if (options.organization !== void 0) {
            assertValidOrganization(options.organization);
        }
        let tokenResponse;
    ...
    async getTokenByMagicLinkCode(url, options) {
        const _await$_assertClassBr8 = await _assertClassBrand(_Class12_brand, this, _discover).call(this), configuration = _await$_assertClassBr8.configuration;
        try {
            const tokenEndpointResponse = await authorizationCodeGrant(configuration, url, {
    ...
    async getTokenByRefreshToken(options) {
        const _await$_assertClassBr9 = await _assertClassBrand(_Class12_brand, this, _discover).call(this), configuration = _await$_assertClassBr9.configuration;
    ...
    async getTokenByPassword(options) {
        const _await$_assertClassBr0 = await _assertClassBrand(_Class12_brand, this, _discover).call(this), configuration = _await$_assertClassBr0.configuration;
        const params = new URLSearchParams({
            username: options.username,
        ...
        if (options.auth0ForwardedFor) {
            const clientAuth = await _assertClassBrand(_Class12_brand, this, _getClientAuth).call(this);
            ...
            requestConfig[customFetch$1] = (url, init) => _classPrivateFieldGet2(_customFetch4, this).call(this, url, _objectSpread2(_objectSpread2({}, init), {}, {
    ...
    async getTokenByPasswordlessEmail(options) {
        ...
        return _assertClassBrand(_Class12_brand, this, _getTokenByPasswordlessOtp).call(this, params);
    }
    ...
    async getTokenByClientCredentials(options) {
        const _await$_assertClassBr1 = await _assertClassBrand(_Class12_brand, this, _discover).call(this), configuration = _await$_assertClassBr1.configuration;
        try {
            const params = new URLSearchParams({
    ...
    async buildLogoutUrl(options) {
        const _await$_assertClassBr10 = await _assertClassBrand(_Class12_brand, this, _discover).call(this), configuration = _await$_assertClassBr10.configuration, serverMetadata = _await$_assertClassBr10.serverMetadata;
    ...
    async verifyLogoutToken(options) {
        const _await$_assertClassBr11 = await _assertClassBrand(_Class12_brand, this, _discover).call(this), serverMetadata = _await$_assertClassBr11.serverMetadata;
...
async function _createConfiguration(serverMetadata) {
    ...
    configuration[customFetch$1] = _classPrivateFieldGet2(_customFetch4, this);
...
async function _discover() {
    ...
    const cacheKey = _assertClassBrand(_Class12_brand, this, _getDiscoveryCacheKey).call(this);
    ...
    if (cached) {
        ...
        _classPrivateFieldSet2(_configuration, this, await _assertClassBrand(_Class12_brand, this, _createConfiguration).call(this, cached.serverMetadata));
        return {
            configuration: _classPrivateFieldGet2(_configuration, this),
            serverMetadata: _classPrivateFieldGet2(_serverMetadata, this)
        };
    ...
    if (inFlight) {
        ...
        _classPrivateFieldSet2(_configuration, this, await _assertClassBrand(_Class12_brand, this, _createConfiguration).call(this, entry.serverMetadata));
        return {
            configuration: _classPrivateFieldGet2(_configuration, this),
            serverMetadata: _classPrivateFieldGet2(_serverMetadata, this)
        };
    ...
    const discoveryPromise = (async () => {
        ...
        const configuration = await discovery(new URL("https://".concat(_classPrivateFieldGet2(_options, this).domain)), _classPrivateFieldGet2(_options, this).clientId, {
            ...
            [customFetch$1]: _classPrivateFieldGet2(_customFetch4, this)
        });
    ...
    const inFlightEntry = discoveryPromise.then(_ref9 => {
        let serverMetadata = _ref9.serverMetadata;
        return {
            serverMetadata: serverMetadata
        };
    });
    ...
    try {
        ...
        _classPrivateFieldGet2(_configuration, this)[customFetch$1] = _classPrivateFieldGet2(_customFetch4, this);
    } finally {
...
async function _exchangeTokenVaultToken(options) {
    ...
    const _await$_assertClassBr12 = await _assertClassBrand(_Class12_brand, this, _discover).call(this), configuration = _await$_assertClassBr12.configuration;
...
async function _exchangeProfileToken(options) {
    const _await$_assertClassBr13 = await _assertClassBrand(_Class12_brand, this, _discover).call(this), configuration = _await$_assertClassBr13.configuration;
    validateSubjectToken(options.subjectToken);
    if (options.organization !== void 0) {
        assertValidOrganization(options.organization);
    }
...
async function _getTokenByPasswordlessOtp(params) {
    const _await$_assertClassBr14 = await _assertClassBrand(_Class12_brand, this, _discover).call(this), configuration = _await$_assertClassBr14.configuration;
    try {
...
async function _buildAuthorizationUrl(options) {
    const _await$_assertClassBr15 = await _assertClassBrand(_Class12_brand, this, _discover).call(this), configuration = _await$_assertClassBr15.configuration;
